...
5. **Content server configured** — port 8081, **no authentication** since 2026-07-05 (`auth False` in `server-config.txt`); LAN-open, do not port-forward 8081
...
- **Content server (easiest):** open http://192.168.1.52:8081, click **Add books** — uploads go straight into the library. (With auth off, uploads are open to the LAN too.)

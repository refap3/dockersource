...
| `calibre/` | `lscr.io/linuxserver/calibre` | Full Calibre desktop streamed to the browser (KasmVNC) + content server for browsing/uploading/downloading books | 8092 (UI, https only), 8081 (content server) | `.env` (auto-generated by `install.sh`) |
...
| `calibre/` | `CALIBRE_UPLOAD_USER`, `CALIBRE_UPLOAD_PASSWORD` | Auto-generated by `install.sh` — login for the content server (upload/download) |
